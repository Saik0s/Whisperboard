...
extension Color.DS {
  ...
  enum Text {
    static var base = Color(hexString: "#FFFFFF")
    static var subdued = Color(hexString: "#9195A8")
    static var accent = Color(hexString: "#ff0831")
    static var accentAlt = Color(hexString: "#abe4fd")
    static var error = Color(hexString: "#FF0000")
    static var success = Color(hexString: "#008000")
    static var warning = Color(hexString: "#FFA500")
    static var link = Color.DS.accents01
    static var overAccent = Color(hexString: "#1C1C1C")
  }
