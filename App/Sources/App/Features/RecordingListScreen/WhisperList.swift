...
//     var whispers: IdentifiedArrayOf<RecordingCard.State> = []
//     var isTranscribing = false
//     var transcribingIdInProgress: RecordingCard.State.ID?
//     var expandedWhisperId: RecordingCard.State.ID?
...
//     case alertDismissed
//     case whisper(id: RecordingCard.State.ID, action: RecordingCard.Action)
//     case transcribeWhisper(id: RecordingCard.State.ID)
//     case transcriptionFinished(id: RecordingCard.State.ID, TaskResult<String>)
//   }
//
...
//           state.whispers = value.map(RecordingCard.State.init(recordingInfo:)).identifiedArray
//
...
//   }
//
//   func whisperRowView(_ childStore: StoreOf<RecordingCard>) -> some View {
...
//     return RecordingCardView(store: childStore, isTranscribing: isTranscribing)
//   }
// }
//
